...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { text: completion } = await generateText({
      ...
      prompt: `Complete the following text in a natural and coherent way. Keep the same tone and style. Only provide the completion, not the original text:
...
Completion:`,
    ...
    console.error('Complete text error:', error);
