    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar lg:ps-[16rem] min-h-svh w-full",
            state === "collapsed" && "lg:ps-0",
            className
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[start,end,width] duration-200 ease-linear md:flex",
          side === "start"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-10 hover:bg-[#32304a]", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
